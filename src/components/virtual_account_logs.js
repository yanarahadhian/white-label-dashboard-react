...
import VirtualAccountLogsList from './virtual_account_logs_list';
import PageMenu from './page_menu';
import { changeNetworkPreferences } from '../middleware/network'
const { Header, Sider, Content } = Layout;

class VirtualAccountLogs extends Component {
  constructor(props) {
    super(props)
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Virtual Account Logs</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Col span={ 8 }>
              ...
              <Switch>
              <Route exact path={ this.props.match.path } component={ VirtualAccountLogsList } />
              {/* <Route path={ this.props.match.path + "/view/:id" } component={ TransactionForm } /> */}
...
export default withRouter(connect(mapStateToProps, { LogUser })(VirtualAccountLogs))