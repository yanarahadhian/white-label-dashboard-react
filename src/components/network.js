          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Network Management</Breadcrumb.Item>
            ...
            <Col span={ 8 }>
              ...
              <Switch>
                <Route exact path={ this.props.match.path } component={ NetworkList } />
                <Route path={ this.props.match.path+"/new" } component={ NetworkForm } />
                <Route path={ this.props.match.path+"/view/:network" } component={ NetworkForm } />
                <Route path={ this.props.match.path+"/edit/:network" } component={ NetworkForm } />
              </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Network))
