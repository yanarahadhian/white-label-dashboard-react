      ...
      <Layout>
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Switch>
              ...
              <Route path={ this.props.match.path + "/view/:user_id" } component={ WalletForm } />
              <Route path={ this.props.match.path + "/edit/:user_id" } component={ WalletForm } />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Wallet))
