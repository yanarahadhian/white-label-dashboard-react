        ...
        return (
            <Layout>
				...
				<Layout>
					...
					<Switch>
						<Route exact path={ this.props.match.path } component={ SubscriptionList } />
						<Route path={ this.props.match.path + '/new' } component={ SubscriptionForm } />
						<Route path={ this.props.match.path + '/view/:id' } component={ SubscriptionForm } />
						<Route path={ this.props.match.path + '/edit/:id' } component={ SubscriptionForm } />
					</Switch>
