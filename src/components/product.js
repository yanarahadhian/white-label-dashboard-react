      ...
      <Layout>
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Switch>
              ...
              <Route path={this.props.match.path+"/new"} component={ProductForm} />
              <Route path={this.props.match.path+"/view/:id"} component={ProductForm} />
              <Route path={this.props.match.path+"/edit/:id"} component={ProductForm} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Product));
