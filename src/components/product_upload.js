...
import ProductUploadList from './product_upload_list';
import ProductUploadForm from './product_upload_form';
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Product Uploads</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Switch>
              <Route exact path={this.props.match.path} component={ProductUploadList} />
              <Route path={this.props.match.path+"/new"} component={ProductUploadForm} />
              <Route path={this.props.match.path+"/view/:id"} component={ProductUploadForm} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(ProductUpload));
