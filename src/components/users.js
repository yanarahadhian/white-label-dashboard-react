          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>User Setting</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Col span={ 8 }>
              ...
              <Switch>
                ...
                <Route path={ this.props.match.path + "/new" } component={ UsersForm } />
                <Route path={ this.props.match.path + "/view/:id" } component={ UsersForm } />
                <Route path={ this.props.match.path + "/edit/:id" } component={ UsersForm } />
             </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Users))
