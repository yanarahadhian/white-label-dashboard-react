...
import SubscriptionLogsList from './subscription_logs_list'
import SubscriptionLogsForm from './subscription_logs_form'
            ...
            <Layout>
                <Header style={{ background: 'rgba(255, 255, 255, 0.7)', paddingLeft: '30px' , textAlign: 'left' }} >
                    <Row type="flex" justify="space-between" align="middle">
                        ...
                        <Breadcrumb separator=">">
                            ...
                            <Breadcrumb.Item>Subscription Logs </Breadcrumb.Item>
                        </Breadcrumb>
                        </Col>
                ...
                <Layout>
					...
					<Content style={{ height: 750 ,padding: 24, background: '#ffffff' }}>
                        ...
                        <Switch>
                            <Route exact path={ this.props.match.path } component={ SubscriptionLogsList } />
                            <Route path={ this.props.match.path + '/view/:id' } component={ SubscriptionLogsForm } />
                        </Switch>
...
export default withRouter(connect(mapStateToProps, null)(SubscriptionLogs))