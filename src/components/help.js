...
import HelpList from './help_list';
    ...
    return (
      <Layout>
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Switch>
              <Route exact path={this.props.match.path} component={HelpList} />
              <Route path={this.props.match.path+"/view/:id"} component={HelpForm} />
              <Route path={this.props.match.path+"/edit/:id"} component={HelpForm} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Help));
