...
import BillerHostList from './biller_host_list'
import BillerHostForm from './biller_host_form'
import { changeNetworkPreferences } from '../middleware/network'
const { Header, Sider, Content } = Layout

class BillerHost extends Component {
    constructor(props) {
        super(props)
    ...
    componentWillMount() {
        ...
        const isTokenExipred = token === null || token === undefined || moment().isAfter(moment(token_exp).format("YYYY-MM-DD HH:mm:ss"))
            ...
            <Layout>
                    ...
                    <Row type="flex" justify="space-between" align="middle">
                        ...
                        <Col span={ 10 }>
                            <Breadcrumb separator=">">
                                ...
                                <Breadcrumb.Item>Biller Host</Breadcrumb.Item>
                            </Breadcrumb>
                        </Col>
                ...
                <Layout>
                    ...
                    <Content style={{ height : 750, padding : 24, background : '#ffffff' }}>
                        ...
                        <Switch>
                            <Route exact path={ this.props.match.path } component={ BillerHostList } ></Route>
                            <Route path={ this.props.match.path + '/new' } component={ BillerHostForm } ></Route>
                            <Route path={ this.props.match.path + '/view/:biller_host_id' } component={ BillerHostForm } ></Route>
                            <Route path={ this.props.match.path + '/edit/:biller_host_id' } component={ BillerHostForm } ></Route>
                        </Switch>
...
export default withRouter(connect(mapStateToProps, null)(BillerHost))