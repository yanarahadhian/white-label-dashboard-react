...
import TransactionForm from './transaction_logs_form';
import TransactionList from './transaction_logs_list';
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Transaction Logs</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Col span={ 8 }>
              ...
              <Switch>
              <Route exact path={ this.props.match.path } component={ TransactionList } />
...
export default withRouter(connect(mapStateToProps, { LogUser })(TransactionLogs))