    ...
    return (
      <Layout>
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Switch>
              <Route exact path={this.props.match.path} component={CustomerList} />
              <Route path={this.props.match.path+"/view/:id"} component={CustomerForm} />
              <Route path={this.props.match.path+"/edit/:id"} component={CustomerForm} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Customer));
