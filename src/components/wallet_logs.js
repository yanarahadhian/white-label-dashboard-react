...
import WalletForm from './wallet_logs_form';
import WalletList from './wallet_logs_list';
      ...
      <Layout>
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Wallet Logs</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
        ...
        <Layout>
          ...
          <Content style={{ height: 750 ,padding: 24, background: '#ffffff' }}>
            ...
            <Switch>
              <Route exact path={ this.props.match.path } component={ WalletList } />
              <Route path={ this.props.match.path + "/view/:id" } component={ WalletForm } />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(WalletLogs))
