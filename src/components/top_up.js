...
import TopUpList from './top_up_list';
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Topup</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Switch>
              <Route exact path={ this.props.match.path } component={ TopUpList } />
              <Route path={ this.props.match.path + "/new" } component={ TopUpForm } />
              <Route path={ this.props.match.path + "/view/:id" } component={ TopUpForm } />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(TopUp))
