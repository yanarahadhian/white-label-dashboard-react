...
import ProductAssignmentList from './product_assignment_list';
import ProductAssignmentForm from './product_assignment_form';
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Product Assignment</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Switch>
              <Route exact path={this.props.match.path} component={ProductAssignmentList} />
              <Route path={this.props.match.path+"/new"} component={ProductAssignmentForm} />
              <Route path={this.props.match.path+"/view/:id"} component={ProductAssignmentForm} />
              <Route path={this.props.match.path+"/edit/:id"} component={ProductAssignmentForm} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(ProductAssignment));
