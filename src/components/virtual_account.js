...
import VAForm from './virtual_account_form';
import VAList from './virtual_account_list';
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Virtual Account</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Col span={ 8 }>
              ...
              <Switch>
                <Route exact path={ this.props.match.path } component={ VAList } />
                <Route path={ this.props.match.path + "/view/:id" } component={ VAForm } />
             </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(VirtualAccount))
