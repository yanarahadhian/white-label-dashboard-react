...
import RoleRights from './role_rights';
        ...
        <Layout>
          ...
          <Content style={{ height: 750 ,padding: 24, background: '#ffffff' }}>
            ...
            <Switch>
              ...
              <Route path={ this.props.match.path + "/new" } component={ RoleForm } />
              <Route path={ this.props.match.path + "/view/:role" } component={ RoleForm } />
              <Route path={ this.props.match.path + "/edit/:role" } component={ RoleForm } />
              <Route path={ this.props.match.path + "/change_rights/:role" } component={ RoleRights } />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Role))
