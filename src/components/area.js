      ...
      <Layout>
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 8 }>
              ...
              <Switch>
                <Route exact path={ this.props.match.path } component={ AreaList } />
                <Route path={ this.props.match.path + "/new" } component={ AreaForm } />
                <Route path={ this.props.match.path + "/view/:area" } component={ AreaForm } />
                <Route path={ this.props.match.path + "/edit/:area" } component={ AreaForm } />
             </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Area))
