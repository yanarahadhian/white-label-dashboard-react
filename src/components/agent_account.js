...
import AgentBulk from './import_file'
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Agent Account</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Switch>
              <Route exact path={this.props.match.path} component={AgentList} />
              <Route path={this.props.match.path+"/new"} component={AgentForm} />
              <Route path={this.props.match.path+"/view/:id"} component={AgentForm} />
              <Route path={this.props.match.path+"/edit/:id"} component={AgentForm} />
              <Route path={this.props.match.path+"/bulk"} component={AgentBulk} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(AgentAccount));
