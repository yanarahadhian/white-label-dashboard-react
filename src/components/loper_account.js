...
import LoperForm from './loper_form';
import LoperList from './loper_list';
import LoperBulk from './import_file'
import PageMenu from './page_menu';
import { changeNetworkPreferences } from '../middleware/network'
const { Header, Sider, Content } = Layout;

class LoperAccount extends Component {
  constructor(props){
    super(props)
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Loper Account</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Switch>
              <Route exact path={this.props.match.path} component={LoperList} />
              <Route path={this.props.match.path+"/new"} component={LoperForm} />
              <Route path={this.props.match.path+"/view/:id"} component={LoperForm} />
              <Route path={this.props.match.path+"/edit/:id"} component={LoperForm} />
              <Route path={this.props.match.path+"/bulk"} component={LoperBulk} />
            </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(LoperAccount));
