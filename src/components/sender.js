...
import SenderList from './sender_list';
          ...
          <Row type="flex" justify="space-between" align="middle">
            ...
            <Col span={ 10 }>
              <Breadcrumb separator=">">
                ...
                <Breadcrumb.Item>Sender ID</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
            ...
            <Col span={ 8 }>
              ...
              <Switch>
                <Route exact path={this.props.match.path} component={SenderList} />
                <Route path={this.props.match.path+"/new"} component={SenderForm} />
                <Route path={this.props.match.path+"/view/:id"} component={SenderForm} />
                <Route path={this.props.match.path+"/edit/:id"} component={SenderForm} />
             </Switch>
...
export default withRouter(connect(mapStateToProps, { LogUser })(Sender))
